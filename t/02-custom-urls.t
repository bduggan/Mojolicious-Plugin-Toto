...
get '/app/beer/browse' => sub { shift->render_text("my name is inigo montoya") };
...
$t->get_ok('/app/beer')->status_is(200);
...
$t->get_ok('/app/beer/browse')->status_is(200)->content_like(qr/inigo montoya/);
